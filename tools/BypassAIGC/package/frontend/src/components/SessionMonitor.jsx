                    ...
                    <div className="flex items-center gap-2 mb-2 flex-wrap">
                      ...
                      {session.processing_mode && (
                        <span className="px-2 py-1 text-xs font-medium rounded bg-blue-100 text-blue-800">
                          {session.processing_mode === 'paper_polish' ? '轻度润色' :
                           session.processing_mode === 'paper_enhance' ? '重点降AI' :
                           session.processing_mode === 'paper_polish_enhance' ? '润色+降AI' :
                           session.processing_mode}
                        </span>
                      )}
                  ...
                  <div key={session.id} className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-3 gap-3 mb-3">
                      ...
                      {session.enhanced_char_count != null && (
                        <div className="bg-blue-50 rounded-lg p-2">
                        <p className="text-xs text-blue-600 mb-1">降AI字符</p>
